<template>
  <div class="m-life">
    <el-row>
      <ul class="nav">
        <li>
          <router-link class="takeout" :to="{path:'/'}">美团外卖</router-link>
        </li>
        <li>
          <router-link class :to="{path:'/'}">猫眼电影</router-link>
        </li>
        <li>
          <router-link class :to="{path:'/'}">美团酒店</router-link>
        </li>
        <li>
          <router-link class="apartment" :to="{path:'/'}">公寓</router-link>
        </li>
        <li>
          <router-link class="business" :to="{path:'/'}">商家入驻</router-link>
        </li>
        <li>
          <router-link class :to="{path:'/'}">美团公益</router-link>
        </li>
      </ul>
    </el-row>
    <el-row>
      ...
      <el-col :span="6">
        <div class="m-life-login">
          ...
          <p v-if='!$store.state.userName'>
            <router-link to="blank/register">
              <el-button round>注册</el-button>
            </router-link>
            <router-link to="blank/login">
